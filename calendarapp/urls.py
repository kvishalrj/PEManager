...
urlpatterns = [
    ...
    path('manager/<int:manager_id>/', views.CalendarViewNew.as_view(), name='calendar_manager'), 
    path('projectEngineer/<int:projectEngineer_id>/', views.CalendarViewNew.as_view(), name='calendar_projectEngineer'), 
